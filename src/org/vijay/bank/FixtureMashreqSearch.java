 ...
 * @author MAC
 */
public class FixtureMashreqSearch extends javax.swing.JInternalFrame {

    /**
     * Creates new form pettySearch
     */
    public FixtureMashreqSearch() {
        initComponents();
    ...
    public void ViewFixtureDohaSearchForm()
    {
        FixtureMashreqSearch  FcbqSearch=new FixtureMashreqSearch();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Date Wise -Fixture Mashreq");
  ...
  //       TODO add your handling code here:
            ...
            ReportView re=new ReportView(path.concat("\\lib\\Reports\\Anar\\Bank\\FixtureMashreq.jasper"),para);
            re.setVisible(true);
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        {
            FixtureDoha FDohaEntry=new FixtureDoha(fDohaId);
            AnarTrading.desktopPane1.add(FDohaEntry);
            FDohaEntry.setVisible(true);
        }
        if(keyCode == KeyEvent.VK_DELETE)
        {
            ...
            else if(response==JOptionPane.YES_OPTION)
            {
                try
                {
                    ...
                    int i=stmt1.executeUpdate("delete from tbl_fixturemashreq  where FmshreqId="+fDohaId);
                    if(i!=0)
                    {
                        dispose();
                        FixtureMashreqSearch  FCS=new FixtureMashreqSearch();
