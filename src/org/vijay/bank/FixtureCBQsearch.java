 ...
 * @author MAC
 */
public class FixtureCBQsearch extends javax.swing.JInternalFrame {

    /**
     * Creates new form pettySearch
     */
    public FixtureCBQsearch() {
        initComponents();
    ...
    public void ViewFixtureCbqSearchForm()
    {
    ...
    public void Search()
    {
        ...
        try
        {
            ...
            ResultSet rs=stmt.executeQuery("SELECT x.FcbqId,x.transDate,x.description, x.debit, x.credit, SUM(y.bal) balance FROM( SELECT *,credit-debit bal FROM tbl_temp_fixturecbq) X JOIN( SELECT *,credit-debit bal FROM tbl_temp_fixturecbq) Y ON y.id <= x.id  WHERE x.transDate BETWEEN '"+Fromdate+"' AND '"+Todate+"' GROUP BY x.id");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Date Wise -Fixture CBQ");
  ...
  //       TODO add your handling code here:
            ...
            ReportView re=new ReportView(path.concat("\\lib\\Reports\\Anar\\Bank\\FixtureCBQ.jasper"),para);
            re.setVisible(true);
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        {
           FixtureCBQ FcbqEntry=new FixtureCBQ(FcbqId);
            AnarTrading.desktopPane1.add(FcbqEntry);
            FcbqEntry.setVisible(true);
        }
        if(keyCode == KeyEvent.VK_DELETE)
        {
            ...
            else if(response==JOptionPane.YES_OPTION)
            {
                try
                {
                    ...
                    {
                        dispose();
                        FixtureCBQsearch  FCS=new FixtureCBQsearch();
                        AnarTrading.desktopPane1.add(FCS);
                        FCS.setVisible(true);
                        FCS.show();
                    }
                }
