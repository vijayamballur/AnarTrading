 ...
 * @author MAC
 */
public class FixtureDohaSearch extends javax.swing.JInternalFrame {

    /**
     * Creates new form pettySearch
     */
    public FixtureDohaSearch() {
        initComponents();
    ...
    {
        FixtureDohaSearch  FcbqSearch=new FixtureDohaSearch();
    ...
    public void Search()
    {
        ...
        try
        {
            ...
            ResultSet rs=stmt.executeQuery("SELECT x.FdohaId,x.transDate,x.description, x.debit, x.credit, SUM(y.bal) balance FROM( SELECT *,credit-debit bal FROM tbl_temp_fixdoha) X JOIN( SELECT *,credit-debit bal FROM tbl_temp_fixdoha) Y ON y.id <= x.id  WHERE x.transDate BETWEEN '"+Fromdate+"' AND '"+Todate+"' GROUP BY x.id");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Date Wise -Fixture Doha");
  ...
  //       TODO add your handling code here:
            ...
            ReportView re=new ReportView(path.concat("\\lib\\Reports\\Anar\\Bank\\FixtureDoha.jasper"),para);
            re.setVisible(true);
        ...
        if(keyCode == KeyEvent.VK_DELETE)
        {
            ...
            else if(response==JOptionPane.YES_OPTION)
            {
                try
                {
                    ...
                    {
                        dispose();
                        FixtureDohaSearch  FCS=new FixtureDohaSearch();
